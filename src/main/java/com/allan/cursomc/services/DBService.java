...
import com.allan.cursomc.repositores.CidadeRepository;
import com.allan.cursomc.repositores.ClienteRepository;
import com.allan.cursomc.repositores.EnderecoRepository;
import com.allan.cursomc.repositores.EstadoRepository;
...
public class DBService {
	...
	public void instatiateTestDatabase() throws ParseException {
		...
		Categoria cat7 = new Categoria(null, "Produtos");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "41525879030", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("(66) 3427-5786", "(97) 2544-9947"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "apto 21", "Jardim Verde", "89291095", cli1, c1);
		Endereco e2 = new Endereco(null, "Rua Lima", "402", "casa", "Parque", "90840826", cli1, c2);

		Cliente cli2 = new Cliente(null, "José Martins", "jose@gmail.com", "96599166040", TipoCliente.PESSOAJURIDICA);
		cli2.getTelefones().addAll(Arrays.asList("(65) 2756-8517"));

		Endereco e3 = new Endereco(null, "Avenida", "500", "loja", "Centro", "23835480", cli2, c3);
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("20/11/2017 00:00"),
				null);
